...
private void updateCountsDisplay(int DistributorTotalAmount, int OutletTotalAmount) {
    ...
    private void loadoutletpayment(){
        ...
        try {
            ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `transaction` "
    ...
    private void initComponents() {
        ...
        jPanel4.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 360, 110, 30));
        ...
        jPanel4.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 400, 290, 30));
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 960, 500));
...
loadoutletpayment();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            MySQL2.executeIUD("UPDATE `distributor_payment` SET payment_status_id = '"+paymentstatusMap.get(paymentstatus)+"' WHERE id = '"+distributorID+"'");
