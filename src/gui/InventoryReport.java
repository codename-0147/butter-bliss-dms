...
public class InventoryReport extends javax.swing.JDialog {
     ...
     */
    public InventoryReport(javax.swing.JPanel parent, boolean modal) {
   ...
   private void loadTable(){
         ...
         try {
              ResultSet resultset = MySQL.executeSearch("SELECT * FROM `stock` INNER JOIN `product`"
            ...
            while (resultset.next()) {
                ...
                vector.add(resultset.getString("stock.status"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Product", "Quantity", "Price", "MFD", "EXP", "Status"
            }
        ) {
