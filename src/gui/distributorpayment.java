...
public class distributorpayment extends javax.swing.JFrame {
    ...
    try {
        ...
        int rowsAffected = MySQL2.executeIUD
    ...
    private void loadDistributorPayment() {
        ...
        try {
            ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `distributor_payment`"
    ...
    private void loadpaymentstatus() {
        try {
            ...
            ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `payment_status`");
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/file (4).png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/icons8-add-26.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/icons8-update-26.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/icons8-print-35.png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Source/icons8-delete-38.png"))); // NOI18N
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        jPanel2.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 5, 50, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            if (DistributorID.isEmpty()) {
                ...
                ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `distributor_payment` WHERE `distributor_id` = '" + DistributorID + "'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (DistributorId.isEmpty()) {
                ...
                ResultSet resultSet = MySQL2.executeSearch("SELECT * FROM `distributor` WHERE `id` = '" + DistributorId + "'");
            ...
            if (DistributorID.isEmpty()) {
                ...
                if (resultSet.next()) {
                    ...
                    if(!resultSet.getString("id").equals(DistributorpayID)){
                        ...
                        MySQL2.executeIUD("UPDATE distributor_payment  SET  amount = '" + salary + "' , payment_date = '" + sdf.format(paymentDate) + "' , `description` = '" + description + "', `payment_status_id` = '" + paymentstatusMap.get(paymentStatus) + "' "
