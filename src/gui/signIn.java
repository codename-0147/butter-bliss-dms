...
private static HashMap<String,String> loadReason = new HashMap<>();
       ...
       private void loadDep(){
          ...
          try {
            ...
            while (resultset.next()) {
                ...
                loadReason.put(resultset.getString("dep_name"),resultset.getString("id"));
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Picture2.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons8-eye-24.png"))); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Picture2.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String department = String.valueOf(jComboBox1.getSelectedIndex());
...
//                 ResultSet resultset = MySQL.executeSearch("SELECT * FROM `admin` INNER JOIN `department` "
//                         + "ON `admin`.`department_id` = `department`.`id` "
...
//                    
//                    JOptionPane.showMessageDialog(this, "Success", "Warning",
//                            JOptionPane.WARNING_MESSAGE);
//
////                   Outlet outlet = new Outlet(email, fName, lName);
////                    outlet.setVisible(true);
////                    this.dispose();
//
//                } else {
//                    JOptionPane.showMessageDialog(this, "Invalid Email or Password", "Warning",
//                            JOptionPane.WARNING_MESSAGE);
//                }
