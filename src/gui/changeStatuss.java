 ...
 * @author Piyumi
 */
public class changeStatuss extends javax.swing.JDialog {
    ...
    /**
     * Creates new form changeStatuss
     */
    public changeStatuss(javax.swing.JPanel parent, boolean modal,String product,String returnID,String status) {
        //super(parent, modal);
        initComponents();
        jTextField1.setText(returnID);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(91, 66, 37)));
        jPanel1.setToolTipText("Status Change");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setText("Return Status");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet resultset = MySQL.executeSearch("SELECT * FROM `returns` WHERE `status` = 'Pending'  ");
            if (resultset.next()) {
