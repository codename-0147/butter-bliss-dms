 ...
 * @author Piyumi
 */
public class returnReport extends javax.swing.JDialog {

 
    public returnReport(javax.swing.JPanel parent, boolean modal) {
     ...
     private void generateReportID(){
        String id = "BBRerurn" + System.currentTimeMillis();
       ...
       private void loadTable(){
         ...
         try {
              ResultSet resultset = MySQL.executeSearch("SELECT * FROM `returns` INNER JOIN `product`"
                    + " ON `product`.`id` = `returns`.`product_id` INNER JOIN `distributor` ON `distributor`.`id` = "
            ...
            while (resultset.next()) {
                ...
                vector.add(resultset.getString("returns.id"));
                vector.add(resultset.getString("product.name"));
                vector.add(resultset.getString("distributor.name"));
                vector.add(resultset.getString("returns.date"));
                vector.add(resultset.getString("returns.reason_id"));
                vector.add(resultset.getString("returns.qty"));
                vector.add(resultset.getString("returns.status"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("R E T U R N S   R E P O R T");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Product", "Quantity", "Date", "Status", "Distributor", "Outlet"
            }
        ) {
